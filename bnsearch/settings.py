# Django settings for bnsearch project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'bnsearch.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'g18v8(&amp;x1(uod5)f*#%3h9w#6zyngrns+^on2p&amp;00a13%$y75e'
...
ROOT_URLCONF = 'bnsearch.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bnsearch.wsgi.application'
